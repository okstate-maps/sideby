  ...
  onClick(e) {
    ...
    <>
        <div className="inputGroup">
            <label className="textInputLabel" htmlFor="overlayUrl">Url: </label>
            <textarea name="overlayUrl" placeholder="Enter the URL to your map/data."></textarea>
            <FontAwesomeIcon data-tip={Config.tooltips.AddOverlayUrl} data-for="modal" icon='info-circle' />
        </div>
        <div className="radioGroup">
            <label className="radioGroupLabel" htmlFor="overlayType">Type</label>
                <div className="inputGroup">
                    ...
                    <FontAwesomeIcon data-tip={Config.tooltips.AddOverlayTileLayer} data-for="modal" icon='info-circle' />
                </div>
        ...
        <div className="inputGroup">
            <label className="textInputLabel" htmlFor="overlay-input-displayName">Display Name: </label>
